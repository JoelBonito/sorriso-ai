...
// Note: PDF generation now happens via Edge Function after budget is created in database
...
export default function SimulatorPage() {
  ...
  const handleApprove = async () => {
    ...
    try {
      ...
      // Primeiro criar o orçamento no banco de dados
      console.log('→ Criando orçamento no banco de dados...');
      ...
      console.log('✓ Orçamento criado no banco:', createdBudget.id);

      // Agora gerar PDF usando Edge Function (PDFShift)
      console.log('→ Gerando PDF do orçamento via Edge Function (PDFShift)...');
      const budgetPdfUrl = await generateBudgetPDF(createdBudget.id);
