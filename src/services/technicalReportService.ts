...
/**
 * MÉTODO ANTIGO - Gera relatório usando jsPDF (DEPRECATED)
 * @deprecated Use generateTechnicalReportPDF() que usa React-PDF
 */
export async function generateTechnicalReportPDFLegacy(data: TechnicalReportData): Promise<string> {
  const doc = new jsPDF();
  const pageWidth = 210;
